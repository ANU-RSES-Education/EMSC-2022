...
Rayleigh number: $Ra=10^3$ (near the critical value $Ra_c \approx 1707$)
...
The initial perturbation decays back to the conduction profile — sub-critical, no convection sustained.
...
Single steady cell. $\mathrm{Nu} \approx 4.8$.
...
Steady single-cell convection. $\mathrm{Nu} \approx 10.4$.
...
Steady cell at the Blankenbach benchmark value — $\mathrm{Nu} \approx 21$.
...
Strongly time-dependent — plume bursts; $\mathrm{Nu}$ fluctuates roughly 30–50.
